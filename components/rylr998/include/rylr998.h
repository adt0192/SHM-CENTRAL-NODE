...
extern char *is_rylr998_module_init; // to know if we already configured the
...
#define RYLR998_UART_TX_GPIO_NUM GPIO_NUM_33
#define RYLR998_UART_RX_GPIO_NUM GPIO_NUM_32
